 ...
 *
 * The apply method is provided as a way for com.example.qwirkle.messages from a client to
...
public abstract class Message<C> implements Serializable {
     ...
     * be used for com.example.qwirkle.messages received from a client.
